    ...
    (function(e, n) {
        ...
        function M(e, t) {
            var n = pn(e) || Pe(e) ? c(e.length, String) : [],
                o = n.length,
                r = !!o;
            for (var i in e) !t && !Gt.call(e, i) || r && ("length" == i || be(i, o)) || n.push(i);
            return n
        }
        ...
        function K(e) {
            ...
            var t = ke(e),
                n = [];
            for (var o in e)("constructor" != o || !t && Gt.call(e, o)) && n.push(o);
            return n
        }
        ...
        function $(e, t, n, o, r) {
            if (e !== t) {
                ...
                a(i || t, function(a, s) {
                    if (i && (s = a, a = t[s]), Ve(a)) r || (r = new B), ee(e, t, s, n, $, o, r);
                    else {
        ...
        function te(e, t) {
            return t = Kt(void 0 === t ? e.length - 1 : t, 0),
                function() {
                    for (var n = arguments, o = -1, r = Kt(n.length - t, 0), a = Array(r); ++o < r;) a[o] = n[t + o];
                    o = -1;
